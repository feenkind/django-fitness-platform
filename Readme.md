...
Außerdem packages für die lokale MySQL-Datenbank.
...
Wenn das Profil auf invisible gesetzt wurde, wird hier für den Trainer, dem das Profil gehört, eine Warning angezeigt. Für andere Benutzer ist dieses Profil dann nicht sichtbar.
